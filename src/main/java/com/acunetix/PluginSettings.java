...
public class PluginSettings extends BambooActionSupport implements GlobalAdminSecurityAware {
    ...
    private String getValue(String key) {
        Object value = bandanaManager.getValue(PlanAwareBandanaContext.GLOBAL_CONTEXT, "com.acunetix:" + key);
        return (String) value;
    }

    private void setValue(String key, String value) {
        bandanaManager.setValue(PlanAwareBandanaContext.GLOBAL_CONTEXT, "com.acunetix:" + key, value);
    }
}